...
if __name__ == "__main__":
    ...
    data_html_path = Path(f'data') / f'Match {game_id} - Vision - DOTABUFF - Dota 2 Stats.html'
    ...
    events_df.to_csv(out_dir / f'events_{game_id}.csv', index=False)
    print(f'events_{game_id}.csv saved')
    ...
    for eid, event in enumerate(events):
        ...
        title = f'Enemy {enemy_side} - Match {game_id}'
        ...
        cv2.imwrite(str(out_dir / f'enemy_{enemy_side}_{game_id}.jpg'), vis_map)
